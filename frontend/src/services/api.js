...
export const matieresAPI = {
  ...
  categories: ()       => api.get('/matieres/categories'),
...
export const planningAPI = {
  ...
  dashboardSynthese:               p  => api.get('/planning/synthese', { params: p })
                                          .catch(() => ({ data: { kpis: {}, par_maintenancier: [] } })),
  dashboardGraphiques:             p  => api.get('/planning/graphiques', { params: p })
                                          .catch(() => ({ data: { evolution: [], dispo_par_ligne: [], repartition: [], par_semaine: [] } })),
  suiviEquipementsParLigne:        p  => api.get('/planning/suivi-equipements', { params: p })
                                          .catch(() => ({ data: [] })),
  ...
  listerLignes:         p  => api.get('/planning/lignes', { params: p })
                               .catch(() => ({ data: [] })),
...
export const signatairesAPI = {
  liste: () => api.get('/utilisateurs/liste-signataires'),
};
